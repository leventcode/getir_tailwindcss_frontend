        ...
        <div className="bg-white mt-10">
            <div className="container mx-auto">
                ...
                <div className="flex justify-between items-center border-t border-gray-100 mt-6 py-6">
                    <div className="text-gray-700 text-xs flex gap-x-8">
                        &copy; 2021 Getir
                    ...
                    <nav className="flex gap-x-3">
                        ...
                        <a href="#" className="h-8 flex items-center rounded px-2 gap-x-2 text-sm text-gray-500 transition-color hover:bg-primary-brand-color hover:bg-opacity-10 hover:text-primary-brand-color flex items-center justify-center">
                            <BiGlobe size={18}/>
                            Türkçe (TR)
                        </a>
                    </nav>
